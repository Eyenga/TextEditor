...
public class EfficientDocument extends Document
{
	...
	private void processText()
	{
		...
		// If text ended with no sentence-ending punctuation, then said sentence was not
		// counted and the sentence count should be corrected.
		if (isWord(tokens.get(tokens.size() - 1))) numSentences++;

		// Similarly if the text started with a sentence-ending punctuation then the
		// sentence over-counted
		if (!isWord(tokens.get(0))) numSentences--;
