...
public class BasicDocument extends Document
{
	 ...
	 * To count the number of syllables in a word, it uses the following rules: @formatter:off
	 *       Each contiguous sequence of one or more vowels is a syllable, 
	 *       with the following exception: a lone "e" at the end of a word 
	 *       is not considered a syllable unless the word has no other syllables. 
	 *       You should consider y a vowel. @formatter:on
	 *       
	 * Check the examples in the main method below for more information.  
	 * 
	 * This method should process the entire text string each time it is called.  
	...
	public static void main(String[] args)
	{
		...
		// testCase(new BasicDocument(".......to."), 0, 0, 2);
	}
